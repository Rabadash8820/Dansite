...
export class GithubPagesWebsiteStack extends Stack {
    /**
     * The S3 Bucket for storing CloudFront and S3 server access logs.
     */
    public readonly logBucket: s3.Bucket;

    constructor(scope: Construct, id: string, props: GithubPagesWebsiteProps) {
        ...
        new route53.TxtRecord(this, "RootTxt", {
            zone: hostedZone,
            comment: `Add DNS verification for domain-based services like Microsoft Exchange, Google Search, etc. for ${props.apexDomainName}`,
            recordName: "",
        ...
        if (props.githubOrganizationDnsVerificationChallenge) {
