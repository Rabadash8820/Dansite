...
export class HealthCheckAlarmStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props: HealthCheckAlarmStackProps) {
        ...
        // Th website is completely static, so the only latency in requests is caused by Route 53 DNS lookup and GitHub Pages download speeds.
